...
<openmrs:require privilege="Manage search/listing on Patient Exited from care" otherwise="/login.htm" redirect="/module/tracpatienttransfer/patientExitedFromCare.list" />

<h2><spring:message code="tracpatienttransfer.patientExitedFromCare"/></h2>
<br/>
...
<div style="margin:5px;">
	<div id="data" style="margin: auto; width: 97%; font-size: 0.9em;">
		...
		<div id="list_container" style="width: 99%; padding-top: 4px;">
			...
			<table id="list_data">
				<tr>
					<th rowspan="2" width="12%" class="columnHeader"><spring:message code="tracpatienttransfer.general.exitwhen"/> ?</th>
					...
					<th rowspan="2" width="20%" class="columnHeader"><spring:message code="tracpatienttransfer.general.reasonofexit"/></th>
						...
						<tr>
							<c:if test="${prevPage!=-1}">
								<td width="100px" class="" style="padding:1px 2px 1px 2px; vertical-align: text-top;">
									<a href="patientExitedFromCare.list?page=1${prmtrs}"><div class="list_pageNumber" style="text-align: center;">|&lt; <spring:message code="tracpatienttransfer.first"/></div></a>
								</td>
							...
							<c:if test="${nextPage!=-1}">
								...
								<td width="100px" class="" style="padding:1px 2px 1px 2px; vertical-align: text-top;">
									<a href="patientExitedFromCare.list?page=${lastPage}${prmtrs}"><div class="list_pageNumber" style="text-align: center;"><spring:message code="tracpatienttransfer.last"/> &gt;|</div></a>
								</td>
							</c:if>
						</tr>
					</table>		
		...
		<c:if test="${param.reason eq null}">
			<div style="width: 70%; margin: auto;">
				<div class="list_container">
					<div class="list_title"><spring:message code="tracpatienttransfer.graph.considering.totalnumberofpatient"/></div>
		...
		<c:if test="${param.reason ne null}">
			<div style="padding-top: 5px;">
				...
				<div style="width: 60%; float: right;">
					<div class="list_container">
						<div class="list_title"><spring:message code="tracpatienttransfer.graph.last12monthevolution"/></div>
						<div class="chartHolder">
